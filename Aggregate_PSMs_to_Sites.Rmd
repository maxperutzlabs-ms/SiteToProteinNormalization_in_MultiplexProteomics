...
## Specify the column denoting the integer number of modifications for the respective precursor peptide of the PSM.
number_modifications_colname = "Number.of.Acetyl..K." 
...
## Add vector denoting the number of different modifications per site (based on specified parameter number_modifications_colname)
df_feature$number_modifications <- df_feature[,number_modifications_colname]
