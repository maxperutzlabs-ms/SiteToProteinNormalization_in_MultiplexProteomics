...
## Required Data Input [using MS3-Quantified Poteins]
...
## Required Data Input [using MS2-Quantified Poteins]
...
In both cases (i.e. normalization to either MS3-quantified proteins, or MS2-quantified proteins), the output comprises:
...
- various intermediate output tables which serve as input for the final script **Normalize_MS2SiteToProtein.Rmd**.
